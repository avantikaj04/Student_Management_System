...
.enroll {
	background: linear-gradient(rgba(0, 0, 0, 0.55),
		rgba(0, 0, 0, 0.55)), url("images/adds.png");
...
<body>
	<div class="card">
		...
		<nav class="d-flex justify-content-between p-2 border border-primary">
			<img src="images/cjc1.png" width="100px" height="55px">
			<div class="pt-2">
				<a href="#enroll">
		...
		<section class="view" style="height: 630px" id="view">
			<h1>View Student</h1>
...
name="batchNumber"> 
               ...
               <a href="#view"> <button class="btn btn-outline-primary mb-1">Search</button> </a>             
           </form> 
   <marquee> 
        <h1 style="color: red;"> 
           ${message } 
						...
						<tr>
							...
							<td>
								...
								<div class="btn-group btn-group-sm" role="group"
									...
									<a class="btn btn-outline-primary" href="shift?id=${s.studentID}">Shift Batch</a>
  ...
  <ul class="pagination pagination-lg">
    <li class="page-item active" >
      <a class="page-link" aria-current="page" href="pagging?pageno=0">1</a>
    </li>
    <li class="page-item"><a class="page-link" href="pagging?pageno=1">2</a></li>
    <li class="page-item"><a class="page-link" href="pagging?pageno=2">3</a></li>
  </ul>
</nav>
